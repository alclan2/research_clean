...
# load dataset
df = pd.read_csv(f"datasets/ALCC/post_python_processing/{TC}/{TC}_all_mslp_mslp_avg_table.csv")
...
density = (
    annual_subbasin
    .groupby('sub_basin_name')['annual_mslp']
    .mean()
    .reset_index(name='mslp_mean')
)
