...
ax.set_title('Origin Density (First Node) of TCs + TDs in the North Atlantic (1940-2024)')
...
plt.savefig(r"images/TC_density/TC_origin_density_NAtl_w_subbasin_overlay_TC+TD_v5.png")
plt.show()